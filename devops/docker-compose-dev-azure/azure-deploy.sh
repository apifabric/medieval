...
resourcename="medieval"  # lower case, only
resourcegroup="medieval_rg"
...
# git clone https://github.com/apilogicserver/medieval.git
# cd medieval
...
az group create --name medieval_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group medieval_rg --sku S1 --is-linux
az container create --resource-group medieval_rg --name medieval --image apilogicserver/medieval:latest --dns-name-label medieval --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//medieval.westus.azurecontainer.io:5656'
