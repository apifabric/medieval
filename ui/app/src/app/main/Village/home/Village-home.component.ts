...
@Component({
  selector: 'Village-home',
  templateUrl: './Village-home.component.html',
  styleUrls: ['./Village-home.component.scss']
})
export class VillageHomeComponent implements AfterViewInit {
