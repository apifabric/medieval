...
@Component({
  selector: 'Peasant-home',
  templateUrl: './Peasant-home.component.html',
  styleUrls: ['./Peasant-home.component.scss']
})
export class PeasantHomeComponent implements AfterViewInit {
