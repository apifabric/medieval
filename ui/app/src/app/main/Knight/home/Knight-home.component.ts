...
@Component({
  selector: 'Knight-home',
  templateUrl: './Knight-home.component.html',
  styleUrls: ['./Knight-home.component.scss']
})
export class KnightHomeComponent implements AfterViewInit {
