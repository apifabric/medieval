...
@Component({
  selector: 'Castle-home',
  templateUrl: './Castle-home.component.html',
  styleUrls: ['./Castle-home.component.scss']
})
export class CastleHomeComponent implements AfterViewInit {
